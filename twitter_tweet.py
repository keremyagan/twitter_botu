...
while True:
    try:      
        ...
        for i in content:
            ...
            if current_url=="https://twitter.com/home?lang=tr":#twittera giriş yapıldı
                send_tweet()
            
            elif current_url=="https://twitter.com/login?email_disabled=true&redirect_after_login=%2F":
                #ip adresi yüzünden bağlantı yasaklanmış olabilir
                print("An error occured.")
                driver.close()

            else:
                #giriş için onay maili gerekirse bu işlem yapılır ve hesaba giriş yapılıp tweet atılır
                time.sleep(2)
